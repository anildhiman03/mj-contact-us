	...
	jQuery(document).ready(function() {
		jQuery("#mailform").validate();
			...
			<form action="<?php echo get_permalink($post->ID); ?>" method="post" id="mailform" enctype="multipart/form-data">
                ...
                <?php if(get_option('mjEnableCaptcha')==1){ ?>
                    <div class="h-71">
                ...
                <div class="h-71">
                    <label for="message"><?php echo '<img src="'.WP_CAPTCHA_DIR_URL.'captcha_code_file.php?s=single&rand='.rand().'" />'; ?></label>
			...
			<form method="POST" action="<?php echo ADDFORM; ?>">
				<table>
					<tr>
						...
						<td><input id="formname" maxlength="45" size="30" name="formname" value="<?php echo (isset($data['form_name'])) ? $data['form_name'] : ''; ?>" /></td>
					</tr>	
						
					<tr>
						<td><label for="formid">Form ID: </label></td>
						<td><input id="formid" maxlength="45" size="30" name="formid" value="<?php echo (isset($data['form_div_id'])) ? $data['form_div_id'] : ''; ?>" /></td>
					</tr>
                    
					<tr>
						<td><label for="subject">Subject: </label></td>
						<td><input id="subject" maxlength="45" size="30" name="subject" value="<?php echo (isset($data['form_div_id'])) ? $data['form_div_id'] : ''; ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td><input id="email_cc" maxlength="45" size="30" name="email_cc" value="<?php echo (isset($data['email'])) ? $data['email'] : ''; ?>" /></td>
					</tr>
					
					<tr>
						<td><label for="emailbcc">Email Address (Bcc): </label></td>
						<td><input id="email_bcc" maxlength="45" size="30" name="email_bcc" value="<?php echo (isset($data['email'])) ? $data['email'] : ''; ?>" /></td>
					</tr>
					...
					<tr>
						<td><label for="status">Save Form Data: </label></td>
						<td>
							Yes <input type="radio" id="saved" name="saved" value="1" />
							No  <input type="radio" id="saved" name="saved" checked="checked" value="0" />
						</td>
					</tr>
...
?>
		<div class="wrap">
		<h2><?php _e('Add Contact Form'); ?></h2>
			<form method="POST" action="<?php echo EDITFORM; ?>">
				<table>
					<tr>
						<td><label for="formname">Form Name: </label></td>
						<td><input id="formname" maxlength="45" size="30" name="formname" value="<?php echo (isset($data['form_name'])) ? $data['form_name'] : ''; ?>" /></td>
